...
from generator import generate, GenerationResult, make_ollama_fn, _LOCAL_MODELS
...
def run_backend(name: str, endpoint: str, model_id: str) -> TieredResult:
    ...
    from generator import map_prompt, _strip_fences, parse_stub_map
    import tiktoken
    ...
    from generator import fill_prompt, assemble, _strip_fences as sf
